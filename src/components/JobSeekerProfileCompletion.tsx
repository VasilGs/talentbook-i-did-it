...
import { User, Upload, Plus, X, Calendar, Building2, FileText, Camera, Trash2, Loader2, CheckCircle } from 'lucide-react'
                    ...
                    {checkingVerification ? (
                      ...
                      <div className="flex items-center space-x-3 bg-green-500/20 border border-green-500/40 rounded-lg p-4">
                        ...
                        <div>
                          ...
                          <p className="text-green-300 text-sm">Your account has been successfully verified.</p>
                        </div>
                      </div>
                    ) : (
                      /* Verification Button */
